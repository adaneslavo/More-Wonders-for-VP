...
UPDATE Language_en_US SET Text = Text||'[ICON_BULLET]1-tile[NEWLINE][ICON_BULLET]+2[ICON_RESEARCH]/Era[NEWLINE][ICON_BULLET][COLOR_NEGATIVE_TEXT]-1[ENDCOLOR][ICON_FOOD]/Adjacent Tiles[NEWLINE][NEWLINE][ICON_BULLET](owned) -10% [ICON_HAPPINESS_3][ICON_HAPPINESS_3] Needs Modifier[NEWLINE][ICON_BULLET](owned) +5%[ICON_RESEARCH][ICON_RESEARCH][NEWLINE]' WHERE Tag = 'TXT_KEY_CIV5_FEATURES_KRAKATOA_TEXT';
-- Lake Victoria
