...
-- Giant's Causeway
UPDATE Language_en_US SET Text = Text||'[NEWLINE][ICON_BULLET]2-tile (2 shapes with different abilities)[NEWLINE][ICON_BULLET](owned) [COLOR_POSITIVE_TEXT]Curiosity[ENDCOLOR] promotion for newly created [COLOR:255:230:85:255]Archaeologist[ENDCOLOR] units[NEWLINE][ICON_BULLET](owned) +15%[ICON_TOURISM]/all Landmarks[NEWLINE]' WHERE Tag = 'TXT_KEY_CIV5_FEATURES_CAUSEWAY_A_TEXT';
UPDATE Language_en_US SET Text = Text||'[NEWLINE][ICON_BULLET]2-tile (2 shapes with different abilities)[NEWLINE][ICON_BULLET](owned) [COLOR_POSITIVE_TEXT]Curiosity[ENDCOLOR] promotion for newly created [COLOR:255:230:85:255]Archaeologist[ENDCOLOR] units[NEWLINE][ICON_BULLET](owned) +5%[ICON_TOURISM]/all Landmarks[NEWLINE]' WHERE Tag = 'TXT_KEY_CIV5_FEATURES_CAUSEWAY_B_TEXT';
