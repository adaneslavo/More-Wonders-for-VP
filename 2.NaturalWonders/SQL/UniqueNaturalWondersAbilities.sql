...
VALUES		('BUILDING_SALAR_A_DUMMY',			'BUILDINGCLASS_SALAR_A_DUMMY',			'TXT_KEY_BUILDING_SALAR_A_DUMMY',			NULL,       -1,   -1,        -1,              1,          0,			1,			NULL,					0,						0,							0,								0,					0,					0,						0,								0),
			...
			('BUILDING_CAUSEWAY_A_DUMMY',		'BUILDINGCLASS_CAUSEWAY_A_DUMMY',		'TXT_KEY_BUILDING_CAUSEWAY_A_DUMMY',		NULL,       -1,   -1,        -1,              1,          0,			1,			NULL,					0,						0,							0,								0,					0,					0,						0,								25),
			('BUILDING_CAUSEWAY_B_DUMMY',		'BUILDINGCLASS_CAUSEWAY_B_DUMMY',		'TXT_KEY_BUILDING_CAUSEWAY_B_DUMMY',		NULL,       -1,   -1,        -1,              1,          0,			1,			NULL,					0,						0,							0,								0,					0,					0,						0,								25),
