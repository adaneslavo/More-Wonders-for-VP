...
VALUES		('TXT_KEY_BUILDING_MT_PAEKTU',				'Altar of the Born under the Mountain'),
			...
			('TXT_KEY_BUILDING_SCUBA_RESORT_HELP',		'+1 [ICON_GOLD] Gold and +1 [ICON_TOURISM] Tourism to Atolls in the City. +1 [ICON_GOLD] Gold and +1 [ICON_RESEARCH] Science to Ocean tiles in the City.'),
			...
			('TXT_KEY_BUILDING_OCEAN_FACILITY_HELP',	'+1 [ICON_FOOD] Food and +1 [ICON_RESEARCH] Science to Ocean tiles in the City. All Sea resources in this City gain +1 [ICON_FOOD] Food.');
