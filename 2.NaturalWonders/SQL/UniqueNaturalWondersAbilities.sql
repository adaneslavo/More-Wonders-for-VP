...
VALUES		('TXT_KEY_PROMOTION_KAILASH',				'Holy Mountain'),
			...
			('TXT_KEY_PROMOTION_BERMUDA_TRIANGLE_HELP',	'-2[ICON_MOVES] Movement Points. [COLOR_NEGATIVE_TEXT]Promotion lasts 2 turns[ENDCOLOR].');			
...
VALUES		('PROMOTION_KAILASH',			'TXT_KEY_PROMOTION_KAILASH',			'TXT_KEY_PROMOTION_KAILASH_HELP',			'AS2D_IF_LEVELUP',	1,				0,					0,			0,						0,				0,				0,					0,					12,				'promoVP_atlas_03',				'PEDIA_CIVILIAN',	'TXT_KEY_PROMOTION_KAILASH'),
			...
			('PROMOTION_BERMUDA_TRIANGLE',	'TXT_KEY_PROMOTION_BERMUDA_TRIANGLE',	'TXT_KEY_PROMOTION_BERMUDA_TRIANGLE_HELP',	'AS2D_IF_LEVELUP',	1,				0,					0,			0,						0,				0,				-2,					2,					9,				'PROMOTION_MORE_WONDERS_ATLAS',	'PEDIA_SHARED',		'TXT_KEY_PROMOTION_BERMUDA_TRIANGLE');
