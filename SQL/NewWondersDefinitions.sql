...
-- GGANTIJA (NEW)
	...
	VALUES		('TXT_KEY_BUILDING_GGANTIJA',			'Ggantija'),
				('TXT_KEY_WONDER_GGANTIJA_HELP',		'Grants 50 [ICON_FOOD] Food after construction. All Farms receive +1 [ICON_FOOD] Food. Converts 10% [ICON_PEACE] Faith into [ICON_FOOD] Food.[NEWLINE][NEWLINE]City must be built on or next to a [COLOR_CYAN]Grassland[ENDCOLOR], on a [COLOR_CYAN]Hill[ENDCOLOR] and have [COLOR_CYAN]2 Farms[ENDCOLOR] nearby.'),
...
-- GOEBEKLI TEPE (NEW)
	...
	VALUES		('TXT_KEY_BUILDING_GOEBEKLI_TEPE',			'Goebekli Tepe'),
				('TXT_KEY_WONDER_GOEBEKLI_TEPE_HELP',		'+1 [ICON_PEACE] Faith from Mountains worked by the City.[NEWLINE][NEWLINE]Nearby [ICON_RES_MARBLE] Marble: +1 [ICON_RESEARCH] Science and +1 [ICON_PEACE] Faith.[NEWLINE]Nearby [ICON_RES_STONE] Stone: +1 [ICON_RESEARCH] Science and +1 [ICON_PEACE] Faith.[NEWLINE][NEWLINE]City must have a [COLOR_CYAN]Mountain[ENDCOLOR] and improved [ICON_RES_MARBLE] Marble or [ICON_RES_STONE] Stone nearby.'),
...
-- MAJORVILLE MEDICINE WHEEL (NEW)
	...
	VALUES		('TXT_KEY_BUILDING_MAJORVILLE',			'Majorville Medicine Wheel'),
				('TXT_KEY_WONDER_MAJORVILLE_HELP',		'+1 [ICON_PEACE] Faith from Tundra tiles worked by the City. All Camps receive +1 [ICON_FOOD] Food.[NEWLINE][NEWLINE]All [ICON_RES_BISON] Bison: +1 [ICON_CULTURE] Culture.[NEWLINE][NEWLINE]City must be built on or next to a [COLOR_CYAN]Tundra[ENDCOLOR] and on a [COLOR_CYAN]Hill[ENDCOLOR]. City cannot be built on a [COLOR_NEGATIVE_TEXT]Coast[ENDCOLOR].'),
...
-- MOHENJO-DARO (NEW)
	...
	VALUES		('TXT_KEY_BUILDING_MOHENJO_DARO',			'Mohenjo-daro'),
				('TXT_KEY_WONDER_MOHENJO_DARO_HELP',		'+1 [ICON_FOOD] Food from River tiles worked by the City. Grants [COLOR_POSITIVE_TEXT]Free[ENDCOLOR] Well in the City in which it is built.[NEWLINE][NEWLINE]City must be built on or next to a [COLOR_CYAN]Desert[ENDCOLOR], on a [COLOR_CYAN]Hill[ENDCOLOR] and next to a [COLOR_CYAN]River[ENDCOLOR].'),
...
---------------------------------------------------------	
	...
	VALUES		('TXT_KEY_BUILDING_SKARA_BRAE',			'Skara Brae'),
				('TXT_KEY_WONDER_SKARA_BRAE_HELP',		'All Villages receive +1 [ICON_PRODUCTION] Production and +1 [ICON_GOLD] Gold.[NEWLINE][NEWLINE]All [ICON_RES_COW] Cattle: +1 [ICON_FOOD] Food.[NEWLINE]All [ICON_RES_FISH] Fish: +1 [ICON_FOOD] Food.[NEWLINE]All [ICON_RES_SHEEP] Sheep: +1 [ICON_FOOD] Food.[NEWLINE]All [ICON_RES_WHEAT] Wheat: +1 [ICON_FOOD] Food.[NEWLINE][NEWLINE]City must be built on a [COLOR_CYAN]Coast[ENDCOLOR], on a [COLOR_CYAN]Flat[ENDCOLOR] and have improved [ICON_RES_COW] Cattle, [ICON_RES_FISH] Fish, [ICON_RES_SHEEP] Sheep or [ICON_RES_WHEAT] Wheat nearby.'),
...
-- KARNAK (NEW)
	...
	VALUES		('TXT_KEY_BUILDING_KARNAK',			'Karnak'),
				('TXT_KEY_WONDER_KARNAK_HELP',		'[COLOR_POSITIVE_TEXT]Free[ENDCOLOR] Monument in the City in which it is built. All Monuments receive +1 [ICON_CULTURE] Culture. +1 [ICON_FOOD] Food and +1 [ICON_PEACE] Faith from each Oasis and every 2 Flood Plains worked by this City. +4 [ICON_TOURISM] Tourism with Archeology.[NEWLINE][NEWLINE]City must be built on or next a [COLOR_CYAN]Desert[ENDCOLOR] and have a [COLOR_CYAN]Flood Plains[ENDCOLOR] or an [COLOR_CYAN]Oasis[ENDCOLOR] nearby.'),
...
-- STONEHENGE
	...
	UPDATE Language_en_US SET Text = Text||'[NEWLINE][NEWLINE]City must be built on or next to a [COLOR_CYAN]Grassland[ENDCOLOR], on a [COLOR_CYAN]Flat[ENDCOLOR] and have [COLOR_CYAN]2 Roads[ENDCOLOR] nearby.' WHERE Tag ='TXT_KEY_BUILDING_STONEHENGE_HELP';
--------------------------------------------------------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------------------------------------------------------
-- NAZCA LINES (NEW)
	...
	VALUES		('TXT_KEY_BUILDING_NAZCA',			'Nazca Lines'),
				('TXT_KEY_WONDER_NAZCA_HELP',		'+2 [ICON_FOOD] Food from nearby Plains and +1 [ICON_PEACE] Faith from nearby Hills worked by the City. +1 [ICON_RESEARCH] Science to Camps worked by this City. +4 [ICON_RESEARCH] Science and +2 [ICON_TOURISM] Tourism with Flight.[NEWLINE][NEWLINE]City must be built on or next to a [COLOR_CYAN]Plains[ENDCOLOR], on a [COLOR_CYAN]Hill[ENDCOLOR] and have [COLOR_CYAN]1 Camp[ENDCOLOR] nearby.'),
...
-- WIELICZKA (NEW)
	...
	VALUES		('TXT_KEY_BUILDING_WIELICZKA',			'Wieliczka Salt Mine'),
				('TXT_KEY_WONDER_WIELICZKA_HELP',		'Wonder places 1 new [ICON_RES_SALT] Salt resource inside City range if possible. +5% [ICON_FOOD] Food in all Cities. +2 [ICON_TOURISM] Tourism with Scientific Theory.[NEWLINE][NEWLINE]Nearby [ICON_RES_SALT] Salt: +1 [ICON_FOOD] Food.[NEWLINE][NEWLINE]City must be built on a [COLOR_CYAN]Hill[ENDCOLOR] and have improved [ICON_RES_SALT] Salt nearby.'),
...
-- TEMPLE OF ARTEMIS
	...
	UPDATE Language_en_US SET Text = Text||'[NEWLINE][NEWLINE]City must be built next to a source of [COLOR_CYAN]Fresh Water[ENDCOLOR] and have [COLOR_CYAN]1 Camp[ENDCOLOR] nearby. City cannot be built on or next to a [COLOR_NEGATIVE_TEXT]Desert[ENDCOLOR].' WHERE Tag ='TXT_KEY_WONDER_TEMPLE_ARTEMIS_HELP';
--------------------------------------------------------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------------------------------------------------------
-- MAUSOLEUM OF HALICARNASSUS
	...
	UPDATE Language_en_US SET Text = Text||'[NEWLINE][NEWLINE]City must be built on a [COLOR_CYAN]Coast[ENDCOLOR], on a [COLOR_CYAN]Hill[ENDCOLOR] and have [COLOR_CYAN]1 Quarry[ENDCOLOR] nearby.' WHERE Tag ='TXT_KEY_WONDER_MAUSOLEUM_HALICARNASSUS_HELP';
--------------------------------------------------------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------------------------------------------------------
-- STATUE OF ZEUS
	INSERT INTO Building_LocalResourceOrs 
	...
	-- +Afraid,Guarded,Hostile,War(1) (lua)
	---------------------------------------------------------
	INSERT INTO Building_ResourceYieldChanges
				(BuildingType,				ResourceType,		YieldType,		Yield) 
	VALUES		('BUILDING_STATUE_ZEUS',	'RESOURCE_MARBLE',	'YIELD_FAITH',	2);
	---------------------------------------------------------	
	UPDATE Language_en_US SET Text = Text||'[NEWLINE][NEWLINE]Nearby [ICON_RES_MARBLE] Marble: +2 [ICON_PEACE] Faith.' WHERE Tag ='TXT_KEY_WONDER_STATUE_ZEUS_HELP';
	...
	UPDATE Language_en_US SET Text = Text||'[NEWLINE][NEWLINE]City must have improved [ICON_RES_MARBLE] Marble nearby and at least one other player must be [COLOR_CYAN]Guarded, Afraid, Hostile or War-like[ENDCOLOR] towards you.' WHERE Tag ='TXT_KEY_WONDER_STATUE_ZEUS_HELP';
--============================================--
-- CLASSICAL ERA
--============================================--
-- GREAT LIGHTHOUSE
	...
	UPDATE Language_en_US SET Text = Text||'[NEWLINE][NEWLINE]City must be built on a [COLOR_CYAN]Coast[ENDCOLOR] and next to a [COLOR_CYAN]River[ENDCOLOR], and have a [COLOR_CYAN]Flood Plains[ENDCOLOR] or an [COLOR_CYAN]Oasis[ENDCOLOR] nearby.' WHERE Tag ='TXT_KEY_WONDER_GREAT_LIGHTHOUSE_HELP';
--------------------------------------------------------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------------------------------------------------------
-- GREAT LIBRARY
	...
	UPDATE Language_en_US SET Text = Text||'[NEWLINE][NEWLINE]City must be built on a [COLOR_CYAN]Hill[ENDCOLOR] and have [COLOR_CYAN]Writer''s Guild[ENDCOLOR] already constructed.' WHERE Tag ='TXT_KEY_WONDER_GREAT_LIBRARY_HELP';
--------------------------------------------------------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------------------------------------------------------
-- HANGING GARDENS
	...
	UPDATE Language_en_US SET Text = Text||'[NEWLINE][NEWLINE]City must be built on a [COLOR_CYAN]Flat[ENDCOLOR] and next to a source of [COLOR_CYAN]Fresh Water[ENDCOLOR]. City cannot be built on a [COLOR_NEGATIVE_TEXT]Coast[ENDCOLOR].' WHERE Tag ='TXT_KEY_WONDER_HANGING_GARDEN_HELP';
--------------------------------------------------------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------------------------------------------------------
-- FORUM ROMANUM
	...
	UPDATE Language_en_US SET Text = Text||'[NEWLINE][NEWLINE]City must be built on a [COLOR_CYAN]Flat[ENDCOLOR], next to a [COLOR_CYAN]River[ENDCOLOR] and have a [COLOR_CYAN]Marsh[ENDCOLOR] nearby.' WHERE Tag ='TXT_KEY_BUILDING_FORUM_HELP';
--------------------------------------------------------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------------------------------------------------------
-- MALWIYA MINARET (NEW)
...
-- TERRACOTA ARMY
	...
	UPDATE Language_en_US SET Text = Text||'[NEWLINE][NEWLINE]City must have constructed [COLOR_CYAN]Mine or Quarry[ENDCOLOR] nearby. City cannot be built next to [COLOR_NEGATIVE_TEXT]Water[ENDCOLOR].' WHERE Tag ='TXT_KEY_WONDER_TERRA_COTTA_ARMY_HELP';
--------------------------------------------------------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------------------------------------------------------
...
-- GATE OF THE SUN (NEW)
	...
	VALUES		('TXT_KEY_BUILDING_GATE_OF_SUN',			'Gate of the Sun'),
				('TXT_KEY_WONDER_GATE_OF_SUN_HELP',			'All Walls receive +1 [ICON_RESEARCH] Science. All Mountains and Lakes receive +1 [ICON_CULTURE] Culture. Has 1 slot for [ICON_GREAT_WORK] Great Work of Art. +5% [ICON_RESEARCH] Science during [ICON_GOLDEN_AGE] Golden Age and +5% [ICON_RESEARCH] Science in Cities with Walls.[NEWLINE][NEWLINE]City must be built next to a [COLOR_CYAN]Lake[ENDCOLOR] and have a [COLOR_CYAN]Mountain[ENDCOLOR] nearby.'),
...
-- PARTHENON
	...
	UPDATE Language_en_US SET Text = Text||'[NEWLINE][NEWLINE]City must be built on a [COLOR_CYAN]Hill[ENDCOLOR]. City cannot be built on or next to a [COLOR_NEGATIVE_TEXT]Grassland[ENDCOLOR] nor next to a source of [COLOR_NEGATIVE_TEXT]Fresh Water[ENDCOLOR].' WHERE Tag ='TXT_KEY_WONDER_PARTHENON_HELP';
--------------------------------------------------------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------------------------------------------------------
-- EL GHRIBA SYNAGOGUE (NEW)
	...
	VALUES		('TXT_KEY_BUILDING_EL_GHRIBA',			'El Ghriba Synagogue'),
				('TXT_KEY_WONDER_EL_GHRIBA_HELP',		'[COLOR_POSITIVE_TEXT]Free[ENDCOLOR] Synagogue in the City in which it is built. 30 [ICON_GOLD] Gold from each [ICON_PEACE] Faith Purchase. Has 1 slot for [ICON_GREAT_WORK] Great Work of Art, and starts with [ICON_GREAT_WORK] [COLOR_MAGENTA]Ark of the Covenant[ENDCOLOR].[NEWLINE][NEWLINE]City must be a [COLOR_CYAN]Holy City[ENDCOLOR] and must be built on a [COLOR_CYAN]Flat[ENDCOLOR]. City cannot be built on or next to a [COLOR_NEGATIVE_TEXT]Tundra[ENDCOLOR] nor [COLOR_NEGATIVE_TEXT]Snow[ENDCOLOR]'),
...
-- ORACLE
	...
	UPDATE Language_en_US SET Text = Text||'[NEWLINE][NEWLINE]City must be built on a [COLOR_CYAN]Hill[ENDCOLOR] and have a [COLOR_CYAN]Mountain[ENDCOLOR] nearby. City cannot be built on or next to a [COLOR_NEGATIVE_TEXT]Grassland[ENDCOLOR].' WHERE Tag ='TXT_KEY_WONDER_ORACLE_HELP';
--------------------------------------------------------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------------------------------------------------------
...
-- ANGKOR WAT
	...
	UPDATE Language_en_US SET Text = Text||'[NEWLINE][NEWLINE]City must be built on a [COLOR_CYAN]Flat[ENDCOLOR], next to a [COLOR_CYAN]Lake[ENDCOLOR] and have a [COLOR_CYAN]Jungle[ENDCOLOR] nearby.' WHERE Tag ='TXT_KEY_WONDER_ANGKOR_WAT_HELP';
--------------------------------------------------------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------------------------------------------------------
-- GREAT WALL
	...
	UPDATE Language_en_US SET Text = Text||'[NEWLINE][NEWLINE]City must be built on a [COLOR_CYAN]Hill[ENDCOLOR] and next to a [COLOR_CYAN]River[ENDCOLOR] and at least one other player must be [COLOR_CYAN]Deceptive, Hostile or War-like[ENDCOLOR] towards you.' WHERE Tag ='TXT_KEY_WONDER_GREAT_WALL_HELP';
--------------------------------------------------------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------------------------------------------------------
-- CHAND BAORI (NEW)
...
-- COLOSSUS
	...
	UPDATE Language_en_US SET Text = Text||'[NEWLINE][NEWLINE]City must be built on a [COLOR_CYAN]Coast[ENDCOLOR] and have improved [ICON_RES_COPPER] Copper nearby.' WHERE Tag ='TXT_KEY_WONDER_COLOSSUS_HELP';
--============================================--
-- MEDIEVAL ERA
--============================================--
-- UNIVERSITY OF SANKORE
	...
	UPDATE Language_en_US SET Text = Text||'[NEWLINE][NEWLINE]City must be built on or next to a [COLOR_CYAN]Desert[ENDCOLOR], on a [COLOR_CYAN]Flat[ENDCOLOR] and have [COLOR_CYAN]Library[ENDCOLOR] already constructed. City cannot be built on [COLOR_NEGATIVE_TEXT]Tundra[ENDCOLOR] nor [COLOR_NEGATIVE_TEXT]Snow[ENDCOLOR].' WHERE Tag ='TXT_KEY_WONDER_MOSQUE_OF_DJENNE_HELP';
--------------------------------------------------------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------------------------------------------------------
...
-- HAGIA SOPHIA
	...
	UPDATE Language_en_US SET Text = Text||'[NEWLINE][NEWLINE]City must be a [COLOR_CYAN]Holy City[ENDCOLOR], must be built on a [COLOR_CYAN]Coast[ENDCOLOR] and have a [COLOR_CYAN]Forest[ENDCOLOR] nearby.' WHERE Tag ='TXT_KEY_WONDER_HAGIA_SOPHIA_HELP';
--------------------------------------------------------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------------------------------------------------------
-- BOROBUDUR
	...
	UPDATE Language_en_US SET Text = Text||'[NEWLINE][NEWLINE]City must be a [COLOR_CYAN]Holy City[ENDCOLOR], must be built on or next to a [COLOR_CYAN]Plains[ENDCOLOR] and have a [COLOR_CYAN]Jungle[ENDCOLOR] nearby.' WHERE Tag ='TXT_KEY_WONDER_BOROBUDUR_HELP';
--------------------------------------------------------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------------------------------------------------------
-- LAVAUX (NEW)
...
-- ALHAMBRA
	...
	UPDATE Language_en_US SET Text = Text||'[NEWLINE][NEWLINE]City must be built on a [COLOR_CYAN]Hill[ENDCOLOR], next to a source of [COLOR_CYAN]Fresh Water[ENDCOLOR] and have a [COLOR_CYAN]Forest[ENDCOLOR] nearby.' WHERE Tag ='TXT_KEY_WONDER_ALHAMBRA_HELP';
--------------------------------------------------------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------------------------------------------------------
-- WARTBURG (NEW)
...
-- MACHU PICCHU
	...
	UPDATE Language_en_US SET Text = Text||'[NEWLINE][NEWLINE]City must be built on a [COLOR_CYAN]Hill[ENDCOLOR] and have [COLOR_CYAN]2 Mountains[ENDCOLOR] nearby.' WHERE Tag ='TXT_KEY_WONDER_MACHU_PICHU_HELP';
--------------------------------------------------------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------------------------------------------------------
-- GREAT ZIMBABWE (NEW)
...
-- FORBIDDEN PALACE
	...
	UPDATE Language_en_US SET Text = Text||'[NEWLINE][NEWLINE]City must be [COLOR_CYAN]Capital[ENDCOLOR], must be built on a [COLOR_CYAN]Flat[ENDCOLOR] and have [COLOR_CYAN]Walls[ENDCOLOR] already constructed.' WHERE Tag ='TXT_KEY_WONDER_FORBIDDEN_PALACE_HELP';
--------------------------------------------------------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------------------------------------------------------
...
-- MONT SAINT-MICHEL (NEW)
	...
	VALUES		('TXT_KEY_BUILDING_MICHEL',			'Mont Saint-Michel'),
				('TXT_KEY_WONDER_MICHEL_HELP',		'Grants a [COLOR_POSITIVE_TEXT]Free[ENDCOLOR] Monastery in the City in which it is built. Greatly increase [ICON_STRENGTH] Combat Strength and Hit Points of the City. +3 [ICON_GOLD] Gold and +3 [ICON_TOURISM] Tourism with Electricity.[NEWLINE][NEWLINE]City must be built on a [COLOR_CYAN]single-tile Island[ENDCOLOR].'),
...
-- NOTRE DAME
	...
	UPDATE Language_en_US SET Text = 'Requires completion of [COLOR_MAGENTA]Tradition[ENDCOLOR] Branch. '||Text||'[NEWLINE][NEWLINE]City must be built on a [COLOR_CYAN]Flat[ENDCOLOR], next to a [COLOR_CYAN]River[ENDCOLOR] and have a [COLOR_CYAN]Lumber Mill[ENDCOLOR] nearby.' WHERE Tag ='TXT_KEY_BUILDING_NOTRE_DAME_HELP';
--------------------------------------------------------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------------------------------------------------------
