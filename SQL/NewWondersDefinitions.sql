...
UPDATE Buildings SET Cost = 900, PrereqTech = 'TECH_ARCHITECTURE',   NumPoliciesNeeded = 13, MaxStartEra = 'ERA_INDUSTRIAL' WHERE Type = 'BUILDING_PETERHOF';
-- IND
...
UPDATE Buildings SET Cost = 1600, PrereqTech = 'TECH_ARCHAEOLOGY',   NumPoliciesNeeded = 16, MaxStartEra = 'ERA_MODERN' WHERE Type = 'BUILDING_MUSEUM_ISLAND';
...
INSERT INTO IconTextureAtlases	(Atlas, IconSize, Filename, IconsPerRow, IconsPerColumn) VALUES
	('vpwe_promoAtlas', 256, 'WE_PI_256.dds', '2', '1'),
...
UPDATE Buildings SET MutuallyExclusiveGroup = 64, PolicyType = 'POLICY_PIETY_FINISHER' 		 WHERE Type IN ('BUILDING_RED_FORT',        'BUILDING_STPETERS');
...
UPDATE Buildings SET MutuallyExclusiveGroup = 900 WHERE Type = 'BUILDING_PETERHOF' OR Type = 'BUILDING_LEANING_TOWER';
...
'BUILDING_BROOKLYN','BUILDING_MUSEUM_ISLAND', 'BUILDING_TRAFALGAR', 'BUILDING_SOVIETS');
...
('BUILDING_BRANDENBURG_GATE','BUILDING_MUSEUM_ISLAND', 'BUILDING_EMPIRE_STATE_BUILDING', 'BUILDING_LEANING_TOWER', 'BUILDING_PYRAMID', 'BUILDING_RED_FORT', 'BUILDING_STONEHENGE',
...
UPDATE Buildings SET NearbyTerrainRequired = 'TERRAIN_TUNDRA' WHERE Type IN ('BUILDING_PETERHOF');
...
('PROMOTION_DAMASCUS', 'TXT_KEY_PROMOTION_DAMASCUS', 'TXT_KEY_PROMOTION_DAMASCUS_HELP', 'AS2D_IF_LEVELUP', 1, 1, 20, 0, 'vpwe_promoAtlas', 'PEDIA_SHARED', 'TXT_KEY_PROMOTION_DAMASCUS');
...
INSERT INTO Building_YieldPerXFeatureTimes100 (BuildingType, FeatureType, YieldType, Yield) VALUES
...
-- Free Hotel, +1T&2G from all Hotels, When you spend gold, 20% of cost is converted to tourism 
----------------------------------------------------

UPDATE Buildings
SET FreeBuildingThisCity = 'BUILDINGCLASS_HOTEL' --GreatWorkSlotType = 'GREAT_WORK_SLOT_MUSIC', GreatWorkCount = 3, ThemingBonusHelp = 'TXT_KEY_MONTECARLO_THEMING_BONUS_HELP'
WHERE Type = 'BUILDING_MONTECARLO';

INSERT INTO Building_YieldChanges (BuildingType, YieldType, Yield) VALUES
('BUILDING_MONTECARLO', 'YIELD_CULTURE', 3),
('BUILDING_MONTECARLO', 'YIELD_TOURISM', 5),
('BUILDING_MONTECARLO', 'YIELD_GOLD', 8);
...
--VALUES ('BUILDING_MONTECARLO', 'TXT_KEY_THEMING_BONUS_MONTECARLO', 5, 1, 5);

--INSERT INTO Building_ThemingYieldBonus (BuildingType, YieldType, Yield) VALUES
--('BUILDING_MONTECARLO', 'YIELD_GOLD', 10),
--('BUILDING_MONTECARLO', 'YIELD_TOURISM', 8);

INSERT INTO Building_YieldFromPurchase (BuildingType, YieldType, Yield) VALUES
('BUILDING_MONTECARLO', 'YIELD_TOURISM', 20);
...
('TXT_KEY_WONDER_MONTECARLO_HELP',  'Grants a free [COLOR_POSITIVE_TEXT]Hotel[ENDCOLOR] and +1 [ICON_RES_JEWELRY] [COLOR_POSITIVE_TEXT]Jewelery[ENDCOLOR]. All Hotels generate +1 [ICON_TOURISM] Tourism and +2 [ICON_GOLD] Gold. When you spend [ICON_GOLD] Gold to purchase Units or invest in Buildings in this City, 20% of the cost is converted into [ICON_TOURISM] Tourism.[NEWLINE][NEWLINE]Requires completion of [COLOR_CYAN]Artistry Branch[ENDCOLOR]. City must be built on the [COLOR_CYAN]Coast[ENDCOLOR].'),
...
--('TXT_KEY_MONTECARLO_THEMING_BONUS_HELP', 'To maximize your bonus, make sure both Great Works are filled with Music created by you.'),
--('TXT_KEY_THEMING_BONUS_MONTECARLO', 'Salle Garnier Gala Event'); 


----------------------------------------------------
-- MUSEUM_ISLAND - Museum Island
-- Free Hotel, +1T&2G from all Hotels and 3 slots of music
----------------------------------------------------

UPDATE Buildings
SET GreatWorkSlotType = 'GREAT_WORK_SLOT_ART_ARTIFACT', GreatWorkCount = 4, ThemingBonusHelp = 'TXT_KEY_MUSEUM_ISLAND_THEMING_BONUS_HELP'
WHERE Type = 'BUILDING_MUSEUM_ISLAND';

INSERT INTO Building_YieldChanges (BuildingType, YieldType, Yield) VALUES
('BUILDING_MUSEUM_ISLAND', 'YIELD_CULTURE', 3),
('BUILDING_MUSEUM_ISLAND', 'YIELD_TOURISM', 3),
('BUILDING_MUSEUM_ISLAND', 'YIELD_SCIENCE', 3);

INSERT INTO Building_BuildingClassYieldChanges (BuildingType, BuildingClassType, YieldType, YieldChange) VALUES
('BUILDING_MUSEUM_ISLAND', 'BUILDINGCLASS_MUSEUM', 'YIELD_SCIENCE', 1),
('BUILDING_MUSEUM_ISLAND', 'BUILDINGCLASS_MUSEUM', 'YIELD_TOURISM', 1);

INSERT INTO Building_ThemingBonuses (BuildingType, Description, Bonus, MustBeArtifact, RequiresUniquePlayers, AIPriority)
VALUES ('BUILDING_MUSEUM_ISLAND', 'TXT_KEY_THEMING_BONUS_MUSEUM_ISLAND', 5, 1, 1, 5);

INSERT INTO Building_ThemingYieldBonus (BuildingType, YieldType, Yield) VALUES
('BUILDING_MUSEUM_ISLAND', 'YIELD_CULTURE', 10),
('BUILDING_MUSEUM_ISLAND', 'YIELD_SCIENCE', 10);

INSERT INTO Building_Flavors (BuildingType, FlavorType, Flavor) VALUES
('BUILDING_MUSEUM_ISLAND', 'FLAVOR_CULTURE', 30),
('BUILDING_MUSEUM_ISLAND', 'FLAVOR_WONDER', 25),
('BUILDING_MUSEUM_ISLAND', 'FLAVOR_SCIENCE', 40);

INSERT INTO Language_en_US (Tag, Text) VALUES
('TXT_KEY_BUILDING_MUSEUM_ISLAND',     'Museum Island'),
('TXT_KEY_WONDER_MUSEUM_ISLAND_HELP',  'Contains 4 slots for Artifacts that provides +10 [ICON_RESEARCH] Science and +10 [ICON_CULTURE] Culture when Themed. All Museum gives +1 [ICON_RESEARCH] Science and +1 [ICON_TOURISM] Tourism. Must be built next to a [COLOR_CYAN]river[ENDCOLOR] and on [COLOR_CYAN]flat[ENDCOLOR] terrain.'),
...
('TXT_KEY_MUSEUM_ISLAND_THEMING_BONUS_HELP', 'To get the theming bonus, make sure to have 4 artifacts from different players and different eras.'),
('TXT_KEY_THEMING_BONUS_MUSEUM_ISLAND', 'Wonders of Museumsinsel'); 
...
INSERT INTO Building_SpecificGreatPersonRateModifier (BuildingType, SpecialistType, Modifier) VALUES
('BUILDING_NABAWI', 'SPECIALIST_WRITER', 25);
...
('TXT_KEY_WONDER_NABAWI_HELP',  'Grants a free [COLOR_POSITIVE_TEXT]Mosque[ENDCOLOR]. All Cities generate +10% [ICON_PEACE] Faith. Has 2 slot for [ICON_GREAT_WORK] Great Works of Writing that provide +4 [ICON_PEACE] Faith and [ICON_GOLDEN_AGE] Golden Age Points if Themed. +25% faster generation of [ICON_GREAT_WRITER] Great Writers in the City.[NEWLINE][NEWLINE]Must be built in a [COLOR_CYAN]Holy City[ENDCOLOR].'),
...
----------------------------------------------------
-- NAZCA - Nazca Lines
-- +1 Faith from Shrines, Tourism with Flight, +1 Food and +1 Faith from Plains, +1 Sci in city
----------------------------------------------------
...
('TXT_KEY_WONDER_NAZCA_HELP',  'Nearby Plains receive +1 [ICON_FOOD] Food and +1 [ICON_PEACE]. All Shrines receive +1 [ICON_PEACE] Faith. +4 [ICON_TOURISM] Tourism with Flight.[NEWLINE][NEWLINE]City must be built on a [COLOR_CYAN]Hill[ENDCOLOR] and on or next to [COLOR_CYAN]Plains[ENDCOLOR].'),
...
-- +1 Trade Route, 15% increased great people generation in this city, We love the king day begins in the city and produces 10% more culture, gold and food
----------------------------------------------------

UPDATE Buildings
SET NumTradeRouteBonus = 1, WLTKDTurns = 20, GreatPeopleRateModifier = 15
WHERE Type = 'BUILDING_PETERHOF';

INSERT INTO Building_YieldChanges (BuildingType, YieldType, Yield) VALUES
('BUILDING_PETERHOF', 'YIELD_CULTURE', 3);

INSERT INTO Building_WLTKDYieldMod (BuildingType, YieldType, Yield) VALUES
('BUILDING_PETERHOF', 'YIELD_FOOD', 10),
('BUILDING_PETERHOF', 'YIELD_CULTURE', 10),
('BUILDING_PETERHOF', 'YIELD_GOLD', 10);

INSERT INTO Building_Flavors (BuildingType, FlavorType, Flavor) VALUES
('BUILDING_PETERHOF', 'FLAVOR_CULTURE', 25),
('BUILDING_PETERHOF', 'FLAVOR_GOLD', 20),
('BUILDING_PETERHOF', 'FLAVOR_GROWTH', 35),
('BUILDING_PETERHOF', 'FLAVOR_GREAT_PEOPLE', 50);

INSERT INTO Language_en_US (Tag, Text) VALUES
('TXT_KEY_BUILDING_PETERHOF',     'Peterhof Palace'),
('TXT_KEY_WONDER_PETERHOF_HELP',  '+1 trade route. The rate at which [ICON_GREAT_PEOPLE] great people are born in this city increased by 15%. Starts 20 turn of [COLOR_POSITIVE_TEXT]We Love The King Day[ENDCOLOR] in the city. During a [COLOR_POSITIVE_TEXT]We Love The King Day[ENDCOLOR], [ICON_FOOD] Food, [ICON_CULTURE] Culture and [ICON_GOLD] Gold increase by 10%.[NEWLINE][NEWLINE]City must be built on or next to [COLOR_CYAN]Tundra[ENDCOLOR].'),
...
INSERT INTO Building_YieldChanges (BuildingType, YieldType, Yield) VALUES
('BUILDING_SOLOMON', 'YIELD_CULTURE', 3),
('BUILDING_SOLOMON', 'YIELD_FAITH',  3);
...
('PROMOTION_WHITESANDS', 'TXT_KEY_PROMOTION_WHITESANDS', 'TXT_KEY_PROMOTION_WHITESANDS_HELP', 'AS2D_IF_LEVELUP', 1, 2, 1, 'vpwe_promoAtlas', 'PEDIA_AIR', 'TXT_KEY_PROMOTION_WHITESANDS');
