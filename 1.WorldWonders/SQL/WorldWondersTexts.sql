...
UPDATE Language_en_US
SET Text = 'It''s impossible to be a world leader without a solid industry, so [COLOR_YIELD_FOOD]Slater Mill[ENDCOLOR] should be an answer for this call. This unique [COLOR_YIELD_FOOD]Factory[ENDCOLOR] ([ICON_PRODUCTION]; [ICON_GREAT_PEOPLE]; [ICON_HAPPINESS_3]; [ICON_INTERNATIONAL_TRADE]) improves the quality of all other key buildings (+5[ICON_PRODUCTION], +5[ICON_GOLD]/all [COLOR_YIELD_FOOD]Factories[ENDCOLOR], [COLOR_YIELD_FOOD]Stock Exchanges[ENDCOLOR]). Great level of training helps with keeping your borders and trade routes in a good shape (-25%[ICON_GOLD][ICON_GOLD] Tile Purchase Cost; +1[ICON_INTERNATIONAL_TRADE]). Soon you will see, how your investments grant you additional profits (+2[ICON_PRODUCTION], +2[ICON_GOLD]/all [ICON_WONDER] [COLOR_YIELD_FOOD]World Wonders[ENDCOLOR]; 10%[ICON_GOLD][ICON_GOLD] Spent into [ICON_PRODUCTION][ICON_PRODUCTION]).'
