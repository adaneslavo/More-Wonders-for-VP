...
UPDATE Language_en_US SET Text = 'Terrain: [COLOR_CYAN]Mountain (range 2)[ENDCOLOR].'||Text WHERE Tag ='TXT_KEY_WONDER_GOEBEKLI_TEPE_HELP' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='MW-SETTING-REQUIREMENT' AND Value=1);
----------------------------------------------------				
-- Kuk
INSERT INTO Language_en_US 
			(Tag,							Text) 
...
UPDATE Language_en_US SET Text = 'Plot: [COLOR_CYAN]Flat[ENDCOLOR]; Improvement: [COLOR_CYAN]Quarry[ENDCOLOR].'||Text WHERE Tag ='TXT_KEY_WONDER_MALWIYA_HELP' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='MW-SETTING-REQUIREMENT' AND Value=2);
...
UPDATE Language_en_US SET Text = 'Terrain: [COLOR_CYAN]2 Mountains (range 3)[ENDCOLOR]; Player: [COLOR_CYAN]at Peace[ENDCOLOR].'||Text WHERE Tag ='TXT_KEY_WONDER_BAMYAN_HELP' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='MW-SETTING-REQUIREMENT' AND Value=2);
...
UPDATE Language_en_US SET Text = 'Terrain: [COLOR_CYAN]Mountain (range 2)[ENDCOLOR]; Feature: [COLOR_CYAN]Lake[ENDCOLOR].'||Text WHERE Tag ='TXT_KEY_WONDER_GATE_OF_SUN_HELP' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='MW-SETTING-REQUIREMENT' AND Value=2);
...
UPDATE Language_en_US SET Text = 'Special: [COLOR_MAGENTA]Progress Finisher[ENDCOLOR]; Plot: [COLOR_CYAN]Flat[ENDCOLOR]; Terrain: [COLOR_CYAN]Coast[ENDCOLOR]'||Text WHERE Tag ='TXT_KEY_WONDER_BUYUK_HAN_HELP' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='MW-SETTING-REQUIREMENT' AND Value=1);		
----------------------------------------------------
-- Itsukushima Shrine
INSERT INTO Language_en_US 
			(Tag,									Text) 
...
INSERT INTO Language_en_US (Tag, Text) 
VALUES ('TXT_KEY_WONDER_HARMANDIR_HELP_CUT', 'Four open doors to [COLOR_YIELD_FOOD]Harmandir Sahib[ENDCOLOR] welcome everyone, no matter what race they are or religion they follow (-2[ICON_HAPPINESS_3][ICON_HAPPINESS_3] Religious Unrest). Each visitor will be well fed (+2[ICON_FOOD]/all [COLOR_YIELD_FOOD]Buildings yielding [ICON_PEACE][ENDCOLOR]) and treated properly if wounded (5 HP Heal/[COLOR_YIELD_GOLD]Land[ENDCOLOR]). Sikhs'' religion is a peaceful faith (+2[ICON_PEACE]), so please, visit this astonishing [COLOR_YIELD_FOOD]Gurdwara[ENDCOLOR], to convert yourself, and maybe even change someone else''s point of view.');
...
-- Uffizi
INSERT INTO Language_en_US (Tag, Text) 
VALUES ('TXT_KEY_WONDER_UFFIZI_HELP_CUT', '[COLOR_YIELD_FOOD]Uffizi[ENDCOLOR], similarly to any other prestigious art [COLOR_YIELD_FOOD]Gallery[ENDCOLOR] ([COLOR_YIELD_FOOD]free[ENDCOLOR]), is a perfect place for talented artists to share their often shocking creations to wider public (+2[ICON_CULTURE]; 3[ICON_VP_GREATART], if themed: [ICON_CULTURE]). Many art connoisseurs try to catch new faces there, giving them very often the only chance for further development ([COLOR_YIELD_GOLD]free [ICON_GREAT_ARTIST][ENDCOLOR]; +1[ICON_CULTURE]/[ICON_GREAT_WORK][ICON_GREAT_WORK]) and preparing few free spots for their artistic fertileness (-1[ICON_HAPPINESS_3][ICON_HAPPINESS_3] Urbanization).');
				
UPDATE Language_en_US SET Text = 'Feature: [COLOR_CYAN]River[ENDCOLOR]; Great Works: [COLOR_CYAN]3 [ICON_VP_GREATART][ENDCOLOR].'||Text WHERE Tag ='TXT_KEY_WONDER_UFFIZI_HELP' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='MW-SETTING-REQUIREMENT' AND Value=2);
...
INSERT INTO Language_en_US (Tag, Text) 
SELECT 'TXT_KEY_WONDER_MUSEUM_ISLAND_HELP_CUT', '[COLOR_YIELD_FOOD]Museum Island[ENDCOLOR] is an isolated complex of numerous facilities containing one of the biggest artifact collections of the world (4[ICON_VP_GREATART], if themed: [ICON_RESEARCH], [ICON_CULTURE], [ICON_TOURISM]). Visiting any of these [COLOR_YIELD_FOOD]Museums[ENDCOLOR] ([COLOR_YIELD_FOOD]free[ENDCOLOR]; +2[ICON_TOURISM][ICON_TOURISM]) guarantees remarkable feelings (+3[ICON_CULTURE]), and can be a powerful incentive for new generations to catch the bug and join the guild of artist (+50%[ICON_GREAT_ARTIST][ICON_GREAT_ARTIST]).';
				
UPDATE Language_en_US SET Text = 'Special: [COLOR_MAGENTA]Artistry Finisher[ENDCOLOR]; Feature: [COLOR_CYAN]River[ENDCOLOR]; Great Works: [COLOR_CYAN]3[ICON_VP_GREATART][ENDCOLOR].'||Text WHERE Tag ='TXT_KEY_WONDER_MUSEUM_ISLAND_HELP' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='MW-SETTING-REQUIREMENT' AND Value=2);	
...
UPDATE Language_en_US SET Text = 'Great Works: [COLOR_CYAN]4[ICON_VP_GREATWRITING][ENDCOLOR]; Player: [COLOR_CYAN]7 Cities[ENDCOLOR].'||Text WHERE Tag ='TXT_KEY_WONDER_SIKU_QUANSHU_HELP' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='MW-SETTING-REQUIREMENT' AND Value=2);	
...
INSERT INTO Language_en_US (Tag, Text) 
SELECT 'TXT_KEY_WONDER_SIBERIAN_RAILWAY_HELP_CUT', '[COLOR_YIELD_FOOD]Trans-Siberian Railway[ENDCOLOR] can take you to remote wilderness ([COLOR_WATER_TEXT]Trans-Siberian Railway[ENDCOLOR]/[COLOR_YIELD_GOLD]Land[ENDCOLOR]) allowing industry to expand into inhospitable regions (+15%[ICON_GOLD]/[ICON_CONNECTED][ICON_CONNECTED], [ICON_INDUSTRIAL_CONNECTED][ICON_INDUSTRIAL_CONNECTED]). This long connection supports new facilities increasing the value of all modern [COLOR_GREY]Strategic[ENDCOLOR] resources on your territory (+5[ICON_GOLDEN_AGE]/[ICON_RES_COAL][ICON_RES_COAL], [ICON_RES_OIL][ICON_RES_OIL], [ICON_RES_ALUMINUM][ICON_RES_ALUMINUM], [ICON_RES_URANIUM][ICON_RES_URANIUM]) and giving new workplaces for your extending empire (+25%[ICON_WORKER] Worker Rate).';
...
UPDATE Language_en_US SET Text = 'Terrain: [COLOR_CYAN]Mountain (range 2)[ENDCOLOR]; Feature: [COLOR_CYAN]Forest[ENDCOLOR].'||Text WHERE Tag ='TXT_KEY_WONDER_RUSHMORE_HELP' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='MW-SETTING-REQUIREMENT' AND Value=2);
UPDATE Language_en_US SET Text = 'Terrain: [COLOR_CYAN]Mountain (range 2)[ENDCOLOR].'||Text WHERE Tag ='TXT_KEY_WONDER_RUSHMORE_HELP' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='MW-SETTING-REQUIREMENT' AND Value=1);
----------------------------------------------------
-- Statue of Liberty
UPDATE Language_en_US
...
UPDATE Language_en_US SET Text = 'Special: [COLOR_MAGENTA]Industry Finisher[ENDCOLOR]; Plot: [COLOR_CYAN]Flat[ENDCOLOR]; Great Works: [COLOR_CYAN]2[ICON_VP_GREATMUSIC][ENDCOLOR].'||Text WHERE Tag ='TXT_KEY_WONDER_BROADWAY_HELP' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='MW-SETTING-REQUIREMENT' AND Value=2);
...
VALUES		('TXT_KEY_BUILDING_ANITKABIR',		'Anitkabir'),
			...
			('TXT_KEY_WONDER_ANITKABIR_PEDIA',	'Anıtkabir is the mausoleum of Mustafa Kemal Atatürk, the founder and first President of the Republic of Turkey, located in Ankara. Its construction began in 1944 and was completed in 1953, following an architectural competition that emphasized both grandeur and symbolic meaning. Designed by architects Emin Onat and Orhan Arda, Anıtkabir was conceived as a national monument to honor Atatürk''s leadership in the Turkish War of Independence and his pivotal role in establishing a secular, modern Turkish state. The site was deliberately placed on a hill overlooking the city, symbolizing Atatürk''s vision and enduring influence on the nation. Anıtkabir has since become a central place for national ceremonies, commemorations, and public homage. [NEWLINE][NEWLINE]The mausoleum combines elements of modern and classical architecture, with a massive ceremonial plaza, grand colonnades, and an imposing main hall housing Atatürk''s tomb. Surrounding the structure are museums exhibiting personal belongings, documents, and photographs related to Atatürk''s life and Turkey''s founding era. The complex also features symbolic reliefs and inscriptions reflecting themes of independence, unity, and progress. Beyond its architectural and historical significance, Anıtkabir serves as a cultural and educational site, attracting millions of visitors annually and standing as a powerful symbol of Turkish identity, national pride, and the enduring legacy of Mustafa Kemal Atatürk.'),
...
VALUES		('TXT_KEY_BUILDING_REVOLUTIONARY_MUSEUM',		'Revolutionary Museum'),
			...
			('TXT_KEY_WONDER_REVOLUTIONARY_MUSEUM_PEDIA',	'The Korean Revolution Museum, located at the foot of Mansu Hill in Pyongyang, North Korea, was first established in 1948 and later expanded in 1960. It stands as one of the largest museums in the country, built to commemorate and narrate the revolutionary history of North Korea under the leadership of Kim Il Sung and Kim Jong Il. The museum showcases North Korea''s official version of its history, beginning with the anti-Japanese resistance struggles of the early 20th century, through the Korean War (1950–1953), and into the development of the socialist state. Its structure and size reflect its symbolic importance, with vast exhibition halls designed to project grandeur and revolutionary pride. [NEWLINE][NEWLINE]Inside, the museum houses dozens of exhibition rooms containing artifacts, photographs, documents, dioramas, and large-scale displays. These exhibits are carefully curated to emphasize the leadership and legacy of the Kim family, portraying them as central to every major historical event. Visitors encounter narratives that blend history with ideology, highlighting themes of struggle, sacrifice, and national unity. The Korean Revolution Museum serves both as a historical institution and as a political tool, reinforcing the state''s official ideology, Juche, and cultivating loyalty to the ruling family. It continues to be a required destination for North Korean citizens on organized visits, as well as a tightly controlled site for foreign tourists.'),
...
UPDATE Language_en_US SET Text = 'Special: [COLOR_MAGENTA]Rationalism Finisher[ENDCOLOR]; Terrain: [COLOR_CYAN]Mountain (range 2)[ENDCOLOR]; Improvement: [COLOR_CYAN]Academy[ENDCOLOR].'||Text WHERE Tag ='TXT_KEY_WONDER_ARECIBO_HELP' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='MW-SETTING-REQUIREMENT' AND Value=2);
UPDATE Language_en_US SET Text = 'Special: [COLOR_MAGENTA]Rationalism Finisher[ENDCOLOR]; Terrain: [COLOR_CYAN]Mountain (range 2)[ENDCOLOR].'||Text WHERE Tag ='TXT_KEY_WONDER_ARECIBO_HELP' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='MW-SETTING-REQUIREMENT' AND Value=1);
----------------------------------------------------
-- Pentagon
UPDATE Language_en_US
...
UPDATE Language_en_US SET Text = 'Terrain: [COLOR_CYAN]Mountain (range 2)[ENDCOLOR]; Feature: [COLOR_NEGATIVE_TEXT]Water[ENDCOLOR]; Improved Resource: [ICON_RES_ALUMINUM].'||Text WHERE Tag ='TXT_KEY_WONDER_CURIOSITY_HELP' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='MW-SETTING-REQUIREMENT' AND Value=2);
...
UPDATE Language_en_US SET Text = 'Terrain: [COLOR_CYAN]Coast[ENDCOLOR]; Great Works: [COLOR_CYAN]4[ICON_VP_GREATMUSIC][ENDCOLOR].'||Text WHERE Tag ='TXT_KEY_WONDER_SYDNEY_OPERA_HOUSE_HELP' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='MW-SETTING-REQUIREMENT' AND Value=2);
